...
import useUsernameByAddress from '@/app/main/username/hooks/useUsernameByAddress'
...
export default function UsernameDep() {
	const {
		register,
		handleSubmit,
		getValues,
	...
	const { data, isLoading, isError } = useUsernameByAddress(
		getValues('address'),
		isValid
	)
