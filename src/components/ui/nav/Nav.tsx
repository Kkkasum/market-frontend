...
export default function Nav() {
	return (
		<div className='flex items-center justify-center gap-2.5 p-1 mx-2 fixed right-0 left-0 top-auto z-50 text-xs font-normal bg-gray-blue/80 rounded-xl border border-solid border-white/10'>
			<NavLink
