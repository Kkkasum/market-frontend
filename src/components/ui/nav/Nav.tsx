...
export default function Nav() {
	return (
		<div className='flex items-center justify-center gap-2.5 p-2.5 mx-2 mb-1 fixed right-0 left-0 top-auto z-50 text-xs font-normal bg-white/5 rounded-xl border border-solid border-white/10 backdrop-blur-xl'>
			<NavLink
